...
@app.route('/<url>')
def dynamicUrl(url):
    connection = connect(host="localhost", database="student", user="root", password="root")
...
def checkLogIn():
    ...
    connection = connect(host="localhost", database="student", user="root", password="t")
    cur = connection.cursor()
...
@app.route('/mailbhejo')
def mailbhejo():
    msg= Message(subject='mail sender', sender='ayushsharma8821@gmail.com', recipients=['glalwani177@gmail.com'],body=
